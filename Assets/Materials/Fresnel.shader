Shader "Tutorial/012_Fresnel" {
	...
	Properties {
        ...
        [PowerSlider(4)] _fresnelMultiply ("FresnelMultiply", Range(1, 3)) = 1.5
	...
	SubShader {
		...
		#pragma surface surf Standard fullforwardshadows NoLighting alpha
		#pragma target 3.0
		...
		void surf (Input i, inout SurfaceOutputStandard o) {
			...
			o.Emission = _Emission + fresnelColor * _fresnelMultiply;
